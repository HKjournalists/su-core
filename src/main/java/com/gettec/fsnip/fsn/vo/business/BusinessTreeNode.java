...
public class BusinessTreeNode implements Serializable {
	...
	private List<BusinessTreeNode> childrenNodes = new ArrayList<BusinessTreeNode>(0);
	...
	public List<BusinessTreeNode> getChildrenNodes() {
		return childrenNodes;
	}

	public void setChildrenNodes(List<BusinessTreeNode> childrenNodes) {
