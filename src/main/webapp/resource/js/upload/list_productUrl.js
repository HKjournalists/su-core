$(function() {
	...
	product.initialize = function(){
		upload.buildUrlGrid("product", this.templatecolumns, this.templateDS);
	...
	product.templatecolumns = [
                ...
                {width:55,title: fsn.l("Operation"),
				      template:function(e){
						ids = e.id;
						var tag="<a  onclick='return fsn.upload.product.editUrl("+e.id+","+e.packageFlag+")' class='k-button k-button-icontext k-grid-ViewDetail '><span class='k-icon k-edit'> </span>" + fsn.l('添加网址') + "</a>";
...
//						}
       			...
       			transport: {
       	            read : {
       	                ...
       	                url : function(options){
       	                	...
       	                	return portal.HTTP_PREFIX + "/product/getAllProduct/" + configure + "/" + options.page + "/" + options.pageSize;
       	                },
       	                dataType : "json",
	...
	product.editUrl = function(id,packageFlag){
		/* md5加密pid */ 
