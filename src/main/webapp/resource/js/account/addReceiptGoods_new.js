$(function () {
    ...
    PRODUCT_DETAIL_COLUMNS = [{field: "id", title: "编号", width: "5%", filterable: false},
        ...
        {
            field: "", title: fsn.l("操作"), width: 70, template: function (dataItem) {
                var reportUrl = dataItem.reportUrl;
                if(reportUrl!=null){
                    return "<a target='view_window' class='k-button k-button-icontext k-grid-ViewDetail' href='"+ reportUrl +"'><span class='k-icon k-edit'></span>查看报告</a>";
                }
                return "";
            }
        }
