$(function(){
	...
	portal.url_edit = '/fsn-core/views/market/add_testreport.html';
	...
	fsn.initialize=function(){
		...
		upload.buildGridWioutToolBar("report_has_published_grid", fsn.publishedColumn, fsn.publishedReportDS, 350);
	...
	fsn.publishColumn = [	
	                   ...
	                   { field: "tips",title:"消息提示",width:55},
		                   { command: [{name:"edit",
		                   	    ...
		                   	    click:function(e){
		                   	    	fsn.edit(this.dataItem($(e.currentTarget).closest("tr")), portal.url_edit, "publish_edit_testreport");
		                     }},
		                     {name:"review",
