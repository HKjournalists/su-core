...
setAddressValue = function(address, otherAddress, mainAddrId, streetAddrId){
	setAddressValueWithHtmlType(address, otherAddress, mainAddrId, streetAddrId, "input");
};
 ...
 * @author ZhangHui 2015-6-2
 */
setAddressValueWithHtmlType = function(address, otherAddress, mainAddrId, streetAddrId, htmlType){
	$("#" + mainAddrId).val("");
	$("#" + streetAddrId).val("");
