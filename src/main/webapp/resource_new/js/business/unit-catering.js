        ...
        $.ajax({
            ...
            success: function(returnValue){
                ...
                if(busUnit != null){
                    ...
                    var tArr = a.split(".");
                    if(tArr.length>1){
                       $("#operateType_title").text(tArr[1])
                       $("#operateType").val(tArr[1])
                        if(tArr[1] == '单位食堂'){
                        ...
                        if(tArr.length>2){
                            $("#operateScope1_tit").text(tArr[2])
                            $("#operateScope1").val(tArr[2])
                        }
                    }
                }
...
//        		toleranceRange: "",//$("#disToleranceRange").val().trim(),
    ...
    //        });
    //    };
    //    var g = $("#tabstrip2").data("kendoTabStrip");
    //    if(!g){
    //        g =  $("#tabstrip2").kendoTabStrip({
    //            animation:  {
    //                open: {
    //                    effects: "fadeIn"
    //                }
    ...
    //    business_unit.tabStrip = $("#tabstrip2").kendoTabStrip().data("kendoTabStrip");
    //    business_unit.tabStrip.select(0);        // Select by jQuery selector
    //};
