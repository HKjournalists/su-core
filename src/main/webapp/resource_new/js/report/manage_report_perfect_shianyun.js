$(function(){
	...
	fsn.initialize=function(){
		...
		upload.buildGridByBoolbar("report_no_perfect_grid", fsn.publishColumn, fsn.reportDS, "300px", "350px", "");
		upload.buildGridByBoolbar("report_has_published_grid", fsn.publishedColumn, fsn.publishedReportDS, "300px", "350px", "toolbar_template");
		upload.buildGridByBoolbar("report_back_grid", fsn.backColumn, fsn.backReportInputDS, "300px", "350px", "toolbar_template_back");
