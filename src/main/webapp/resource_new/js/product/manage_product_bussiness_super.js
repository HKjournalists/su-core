$(function() {
	...
	product.mytemplatecolumns = [
            ...
            { command: [{name:"review",
            	    ...
            	    click:function(e){
            	    	...
            	    	var	dataItem = this.dataItem($(e.currentTarget).closest("tr"));
         			    /* 打开产品信息预览界面 */
            	    	window.open("/fsn-core/views/product_new/view_report_of_product_bussiness_super.html?" + product.fromBusId + "&" + dataItem.id+"&"+product.fromBuName);
              }}], title: "操作", width: 30 }];
   	...
   	product.queryCountOfReport = function(){
		...
		var backUrl = "/fsn-core/views/erp_new/basic/customer.html?type=3&name=%E4%BE%9B%E5%BA%94%E5%95%86";
