...
portal.customerSelectDataSource=[];
...
portal.initCustomerMultiSelect_lead = function() {
	$("#customerSelect_lead").kendoMultiSelect({
		...
		*/
	    dataSource : portal.customerSelectDataSource,
		placeholder : "请选择...",
		autoBind : true,
		select: portal.setCustomerWidth,
		dataTextField : "name",
...
portal.fillCustomerSelect = function() {
   ...
   portal.customerSelectDataSource =portal.fillCustomerSelectDataSource();
	...
	if(cts_){
		$("#customerSelect_lead").data("kendoMultiSelect").setDataSource(portal.customerSelectDataSource);
