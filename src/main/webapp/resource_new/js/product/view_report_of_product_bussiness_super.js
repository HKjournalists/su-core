$(function() {
	...
	portal.templatecolumns = [
                   ...
                   {field: "productionDate",title: "生产日期",template:'#=productionDate=fsn.formatGridDate(productionDate)#',width: "45px", filterable: false},
    ...
    function setProductValue(product){
    	...
    	if(product.imgList.length!=0){
    		...
    		imgHtml+='<li>';
    		imgHtml+='<a href="#">';
    		imgHtml+='<img style="height:175px;" src="'+"http://qa.fsnrec.com/portal/img/product/temp/temp.jpg"+'"alt="" />';
    		imgHtml+='</a>';
    		imgHtml+='</li>';
    	}
    	...
    	if((portal.fromBusId==null||portal.fromBusId=="null")&&(product.licImg==null||product.licImg=="")){
        	...
        	if(product.licImg != null && product.licImg != "") {
        		$("#licImg").attr("src",product.licImg,140,111);
