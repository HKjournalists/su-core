$(function(){
	...
	st_customer.initailize = function(){
		...
		$("#back").bind("click",function(){
			window.location.href = "/fsn-core/views/erp_new/basic/customerList.html";
		});
	};
...
//	   }
	   ...
	   window.open("/fsn-core/views/product_new/manage_product_bussiness_super_onhandleProductList.html?" + fromBusId + "&" + providername + "&" + organization);
	};
