$(function() {
                ...
                {width:55,title: fsn.l("Operation"),
				      template:function(e){
					    ...
					    if (e.nutriStatus == '0' || e.nutriStatus=='2') {
							return tag  +
							"<a onclick='return lims.upload.product.recalculatedOnClick("+e.id+","+e.nutriStatus+")' class='k-button k-button-icontext k-grid-Backout' id='aid' >重新计算</a>";
						}else{
							return tag;
						}
						return tag;
	...
	product.edit = function(id,packageFlag){
		...
		if(packageFlag=='0'){
			window.location.pathname = "/fsn-core/views/portal/product.html";
		}else{
