...
ALTER TABLE `enterprise_registe`
	ADD COLUMN `passNo` VARCHAR(100) NULL DEFAULT NULL COMMENT '食品流通许可证' AFTER `organizationNo`;
ALTER TABLE `enterprise_registe`
	ADD COLUMN `productNo` VARCHAR(100) NULL DEFAULT NULL COMMENT '生产许可证号' AFTER `organizationNo`;
